...
> **Legacy Figma export:** `Tokens/token-bible.json`
...
The legacy `Tokens/token-bible.json` file is retained as a reference export from the earlier Figma variable setup.
