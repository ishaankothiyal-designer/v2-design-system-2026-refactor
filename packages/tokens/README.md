...
> **Legacy Figma export:** `Tokens/Tokens-variables-full.json`
...
The legacy `Tokens/Tokens-variables-full.json` file is retained as a reference export from the earlier Figma variable setup.
